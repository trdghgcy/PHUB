...
class Video:
    ...
    def __init__(self, client, url, change_title_language=True, use_webmaster_api=True):
        """
    ...
    def _as_query(self):
        ...
        if not self.ALLOW_QUERY_SIMULATION:
            ...
            raise Exception('Query simulation is disabled for this video object. If you still want to continue, set video.ALLOW_QUERY_SIMULATION=True. Be advised this method is not recommended and requires user logging.')
    ...
    def image(self):
        ...
        if url:
            ...
            servers = self.data.get('data@thumbs') or []

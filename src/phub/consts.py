...
HEADERS = {'Accept': '*/*', 'Accept-Language': 'en,en-US', 'Connection': 'keep-alive',
...
LANGUAGE_MAPPING = {'en': 'www.pornhub.com', 'cn': 'www.cn.pornhub.com', 'de': 'www.de.pornhub.org', 'fr': 'www.fr.pornhub.com', 'it': 'www.it.pornhub.com',
                    'pt': 'www.pt.pornhub.com', 'pl': 'www.pl.pornhub.com', 'rt': 'www.rt.pornhub.com', 'nl': 'www.nl.pornhub.com', 'cz': 'www.cz.pornhub.com', 'jp': 'www.jp.pornhub.com'}
GEO_BYPASS_IPs = ['185.238.219.36', '185.238.219.57',
                  '185.238.219.18', '185.238.219.57', '185.238.219.18']
...
class re:
    ...
    eval_video = find(
        engine.DOTALL, 'id=\\"(.*?)\\".*?-vkey=\\"(.*?)\\".*?title=\\"(.*?)\\".*?src=\\"(.*?)\\".*?</div')
    eval_public_video = find(
        engine.DOTALL, '-mediabook=\\"(.*?)\\".*?marker-overlays.*?>(.*?)')
    user_avatar = find(
    ...
    fixed_title = find(engine.DOTALL, '(?<="name": ")[^"]+')
